...
## Key Features
- Skin disease classification (Acne / Eczema)
- Severity detection (Mild / Moderate / Severe)
- Skin layer identification (Epidermis / Dermis)
- Temperament (Mizaj) assessment
- Personalized herbal remedies and diet plans
- Auto-generated PDF report sent via email
- User history and dashboard
- Admin panel for managing users, remedies, and records
...
### Backend
- Node.js
- Python (Flask / Django) for AI services  
...
```bash
git clone https://github.com/your-username/herbalin.git
